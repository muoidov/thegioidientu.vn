        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $.each(res, function (i, item) {
                    var tax1 = parseInt((item.price * item.quantity * 0.1).toFixed(0));
                    ...
                    html += "<tr>"
                        ...
                        + "<td>" + numberWithCommas(tax1) + "</td>"
                        + "<td>" + numberWithCommas(tol) + "</td>"
                        + "</tr>";
                    total += amount;
                    tax += tax1;
                    tolc += tol;
                ...
                $('#lbl_number_of_items').text(itemMounts);
                $('#lbl_total').text(numberWithCommas(tolc));
            }
        });
    }
}